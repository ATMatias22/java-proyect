...
//PUNTO EXTRA DEL EJERCICIO 4
    public ArrayList<Propiedad> listaPropMasBaratasXBarrio(Tipo t) {

        ArrayList<Propiedad> propMasBaratos = new ArrayList<>();

        for (Barrio b : barrios) {
            propMasBaratos.add(b.buscarPropiedadMasBarata(t));
        }
    
        return propMasBaratos;
    }
